...
export const t = {
  vi: {
    ...
    xCc: 'Vị trí trục Xcc',
    yCc: 'Vị trí trục Ycc',
    axisTypical: 'Tên trục điển hình',
    axisHint: 'Bong bóng CAD — tim trục nhập độc lập, không khóa theo tâm cột',
    axisName: 'Tên',
    x1: 'Khoảng cách X1',
    y1: 'Khoảng cách Y1',
    cdn: 'Cao độ nền',
  ...
  en: {
    ...
    xCc: 'Axis Xcc',
    yCc: 'Axis Ycc',
    axisTypical: 'Typical grid-axis bubble',
    axisHint: 'CAD bubble — axis is typed independently, not locked to column center',
    axisName: 'Mark',
    x1: 'Offset X1',
    y1: 'Offset Y1',
    cdn: 'Floor level',
